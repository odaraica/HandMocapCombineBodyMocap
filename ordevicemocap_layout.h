...
/**    \file    ordevicemocap_layout.h
*    Declaration for the layout of a simple motion capture device.
*    Contains the declaration for the layout of a simple motion capture
*    device class, ORDeviceMocapLayout.
*/
...
//! Simple motion capture device layout.
class ORDeviceMocapLayout : public FBDeviceLayout
{
    //--- FiLMBOX declaration.
    FBDeviceLayoutDeclare( ORDeviceMocapLayout, FBDeviceLayout );
...
public:
	...
	void        EventSetAP                                 ( HISender pSender, HKEvent pEvent  );
    // Setup Layout: Events
//     void    EventSetupRecording                        ( HISender pSender, HKEvent pEvent );
     void    EventTargetCharactorChoose                  ( HISender pSender, HKEvent pEvent );
     void    EventClipPath                              ( HISender pSender, HKEvent pEvent );
	 void    EventCharactorSetup                        (HISender pSender, HKEvent pEvent  );
//     void    EventCalibration                           ( HISender pSender, HKEvent pEvent );
//     void    EventFileIOExport                          ( HISender pSender, HKEvent pEvent );
//     void    EventFileIOImport                          ( HISender pSender, HKEvent pEvent );
    //void    EventFileIOStop                         ( HISender pSender, HKEvent pEvent );
...
private:
    ...
    FBLabel             mLabelCharactorize;
    FBButton            mButtonCharactorize;
    FBButton            mButtonExport;
    FBButton            mButtonImport;
    // FBButton            mButtonStop;

private:
    ORDeviceMocap*      mDevice;                    //!< Handle onto device.
};

#endif /* __ORDEVICE_MOCAP_LAYOUT_H__ */
