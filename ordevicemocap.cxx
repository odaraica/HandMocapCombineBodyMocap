...
//--- Library declaration
FBLibraryDeclare( ordevicemocap )
{
	FBLibraryRegister( ORDeviceMocap	);
	FBLibraryRegister( ORDeviceMocapLayout	);
}
FBLibraryDeclareEnd;
...
*	Here are the steps to test the ORDeviceMocap.
